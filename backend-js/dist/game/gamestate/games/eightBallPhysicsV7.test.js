...
(0, node_test_1.default)("v7 resolves an identical quantized break every time", () => {
    const shot = { aimX: 0, aimY: -10000, power: 900 };
    const first = (0, eightBallPhysicsV7_1.simulateEightBallShotV7)((0, eightBallPhysics_1.createEightBallRack)(), shot);
    const second = (0, eightBallPhysicsV7_1.simulateEightBallShotV7)((0, eightBallPhysics_1.createEightBallRack)(), shot);
    ...
    strict_1.default.ok((0, eightBallPhysicsV7_1.eightBallV7MinimumSeparationSquared)(first.balls) >= eightBallPhysicsV7_1.EIGHT_BALL_V7_BALL_DIAMETER_SQUARED, "settled balls must not overlap");
});
(0, node_test_1.default)("v7 swept contacts stop a full-power shot tunnelling through a ball", () => {
    ...
    const simulation = (0, eightBallPhysicsV7_1.simulateEightBallShotV7)(balls, { aimX: 0, aimY: -10000, power: 1000 }, { captureHz: 120 });
    ...
    strict_1.default.ok((0, eightBallPhysicsV7_1.eightBallV7MinimumSeparationSquared)(simulation.balls) >= eightBallPhysicsV7_1.EIGHT_BALL_V7_BALL_DIAMETER_SQUARED, "the colliding pair must finish separated");
});
(0, node_test_1.default)("v7 rolling resistance preserves travel direction before contact", () => {
    const balls = tableWithOnly([0]);
    Object.assign(ballByNumber(balls, 0), { x: 2500, y: 7000, pocketed: false });
    const simulation = (0, eightBallPhysicsV7_1.simulateEightBallShotV7)(balls, { aimX: 3, aimY: -4, power: 120 }, { captureHz: 120 });
...
(0, node_test_1.default)("v7 requires a clean side-pocket approach", () => {
    const shootFrom = (y) => {
        const balls = tableWithOnly([0]);
        Object.assign(ballByNumber(balls, 0), { x: 500, y, pocketed: false });
        return (0, eightBallPhysicsV7_1.simulateEightBallShotV7)(balls, { aimX: -10000, aimY: 0, power: 80 });
    };
...
(0, node_test_1.default)("v7 is horizontally mirror-symmetric", () => {
    const shotFrom = (x, aimX) => {
        const balls = tableWithOnly([0]);
        Object.assign(ballByNumber(balls, 0), { x, y: 2400, pocketed: false });
        return (0, eightBallPhysicsV7_1.simulateEightBallShotV7)(balls, { aimX, aimY: -4000, power: 350 });
    };
...
(0, node_test_1.default)("v7 broad phase rejects most irrelevant pair quadratics", () => {
    const simulation = (0, eightBallPhysicsV7_1.simulateEightBallShotV7)((0, eightBallPhysics_1.createEightBallRack)(), { aimX: 3300, aimY: -10000, power: 280 });
...
(0, node_test_1.default)("v7 never increases translational energy between contact-free captured frames", () => {
    const balls = tableWithOnly([0]);
    ...
    const simulation = (0, eightBallPhysicsV7_1.simulateEightBallShotV7)(balls, { aimX: 1, aimY: 0, power: 120 }, { captureHz: 120 });
...
(0, node_test_1.default)("v7 uses the same physical ball diameter as the production table", () => {
    strict_1.default.equal(eightBallPhysicsV7_1.EIGHT_BALL_V7_BALL_DIAMETER_SQUARED, Math.pow((eightBallPhysics_1.EIGHT_BALL_BALL_RADIUS * 2), 2));
});
(0, node_test_1.default)("v7 contains and separates a deterministic spread of arbitrary shots", () => {
    let seed = 0x51f15e;
    const random = () => {
    ...
    for (let shotIndex = 0; shotIndex < 128; shotIndex += 1) {
        ...
        const simulation = (0, eightBallPhysicsV7_1.simulateEightBallShotV7)((0, eightBallPhysics_1.createEightBallRack)(), {
        ...
        strict_1.default.ok((0, eightBallPhysicsV7_1.eightBallV7MinimumSeparationSquared)(simulation.balls) >= eightBallPhysicsV7_1.EIGHT_BALL_V7_BALL_DIAMETER_SQUARED, `shot ${shotIndex} left overlapping balls`);
    }
});
